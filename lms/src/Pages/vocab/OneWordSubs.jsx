...
const OneWordSubs = () => {
    ...
    const [oneWordSubs, setOneWordSubs] = useState([]);
    ...
    const fetchWords = async () => {
      try {
        const response = await axiosInstance.get("/oneWordSubs/getAll");
        setOneWordSubs(response.data);
      } catch (error) {
    ...
    const groupedData = oneWordSubs.reduce((acc, item) => {
